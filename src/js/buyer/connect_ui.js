...
const BuyerStackProgress = require('./stack_progress_ui.js').BuyerStackProgress;
...
class BuyerConnectUi extends ConnectUi{
    ...
    switchMode(new_mode) {
        ...
        if (new_mode == "ENTER_BEACON") {
            ...
            this.stack_progress = new BuyerStackProgress(this.mode_output_div);
...
exports.BuyerConnectUi = BuyerConnectUi;
